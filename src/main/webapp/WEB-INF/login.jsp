...
<div class="main">
  ...
  <div class="index">
    <form method="post" action="/login">
      ...
      <div><input type="submit" value="Войти" class="grey-button-discipline">Войти</input><div style="width: 299px;"></div></div>

    </form>
    <c:if test="${Error eq 2}">
      <h4>Не верно ввели логин или пароль или не верно выбрана роль</h4>
    </c:if>
